...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.nama.setText(
                datahewan.get(position).getNama());

                holder.info.setText(
                        datahewan.get(position).getInfo());
    ...
    private void updateDeleteData(int position) {
        ...
        final String name = datahewan.get(position).getNama();
        final String info = datahewan.get(position).getInfo();
        final String url = datahewan.get(position).getUrl();

        id = datahewan.get(position).getId();
